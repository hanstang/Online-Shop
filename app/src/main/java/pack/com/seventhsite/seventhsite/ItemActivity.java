...
public class ItemActivity extends ActionBarActivity {
    ...
    ArrayList<String> arrItemrate=new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        easyTracker=EasyTracker.getInstance(ItemActivity.this);
        ...
        //lihat item send event
        easyTracker.send(MapBuilder.createEvent("Lihat Item"+idkat , "onCreate", idkat + "", null).build());
        //tv=(TextView) findViewById(R.id.NamaKategori);
        //tv.setText(i.getExtras().getString("namaKategori").toString());

        listItem=(ListView) findViewById(R.id.ListItem);
        new getItem().execute("http://"+vg.ipconnection+"/service_android/listitem.php?katid="+idkat);
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent myIntent = new Intent(ItemActivity.this, DetailItemActivity.class);
    ...
    class getItem extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog= ProgressDialog.show(ItemActivity.this, "Get Data", "Loading...");
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(result.length()==2)
                {
                    ...
                    dialog.dismiss();
                    finish();
                    Toast.makeText(ItemActivity.this, "No Item in This Category", Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    iadapter = new AdapterItem(ItemActivity.this);
